...
from utils.logging_config import SUCCESS_LEVEL, ColoredFormatter, configure_logging
...
def test_colored_formatter_adds_level_prefix_and_color():
	...
	success = formatter.format(logging.LogRecord("test", SUCCESS_LEVEL, "", 0, "done", (), None))
	error = formatter.format(logging.LogRecord("test", logging.ERROR, "", 0, "failed", (), None))
